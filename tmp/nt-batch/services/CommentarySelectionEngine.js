import { CommentaryCategory } from '../types';
import { PREMATCH_COMMENTARY_DB } from '../data/prematch_commentary_pl';
...
export const CommentarySelectionEngine = {
    selectLines: (context, homeName, awayName, ref) => {
        const transcript = [];
        // 1. Pick Studio Cast
        ...
        const getLine = (speaker, categories) => {
            const pool = PREMATCH_COMMENTARY_DB.filter(t => categories.includes(t.category) &&
