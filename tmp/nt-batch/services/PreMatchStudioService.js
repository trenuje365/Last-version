...
function calcSimulatedOdds(homeRank, awayRank, totalTeams, homeForm, awayForm, homeKeyInjuries, awayKeyInjuries) {
...
export const PreMatchStudioService = {
    prepareStudioData: async (fixture, home, away, homeLineup, awayLineup, homePlayers, awayPlayers, allClubs = []) => {
