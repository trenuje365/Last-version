...
export const LeagueStatsService = {
     ...
     */
    getPlayersForLeague: (leagueId, clubs, playersMap) => {
     ...
     */
    getYellowCardsList: (rows, limit = 50) => {
        return [...rows]
