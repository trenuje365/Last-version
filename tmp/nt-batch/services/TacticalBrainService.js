export const TacticalBrainService = {
    ...
    SCORE_RULES: [
        ...
        },
        {
            ...
            trigger: (diff, min) => diff === 1 && min > 80,
        ...
        },
        {
            ...
            trigger: (diff, min) => diff === -1 && min > 75,
    ...
    EVENT_RULES: [
        {
            ...
            trigger: (s, diff) => (s.minute - (s.lastGoalBoostMinute || 0) < 10) && diff === -1,
