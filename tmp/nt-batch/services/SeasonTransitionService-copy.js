...
export const SeasonTransitionService = {
     ...
     */
    processSquadTransition: (playersMap, clubs) => {
        ...
        for (const clubId in updatedMap) {
            ...
            currentSquad.forEach(player => {
                ...
                if (player.age >= 35 && Math.random() < 0.5) {
                    ...
                    const newgen = SeasonTransitionService.generateNewgen(clubId, player.position, leagueTier, club.reputation, nextSquad.length);
     ...
     */
    generateNewgen: (clubId, position, tier, reputation, index) => {
