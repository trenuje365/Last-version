          ...
          <div className={`${GLASS_PANEL} w-80 rounded-[45px] p-6 flex flex-col shrink-0`}>
            ...
            <div className="flex-1 overflow-y-auto custom-scrollbar pr-1">
              <div className="space-y-[4px]">
                ...
                {homePlayers.slice(0, 11).map(p => renderPlayerRow(p, 'LEFT'))}
                {homePlayers.length > 11 && (
                  <div className="mt-4 pt-4 border-t border-white/5">
                    ...
                    {homePlayers.slice(11).map(p => renderPlayerRow(p, 'LEFT', true))}
                  </div>
                )}
              </div>
            </div>
          ...
          <div className={`${GLASS_PANEL} w-80 rounded-[45px] p-6 flex flex-col shrink-0`}>
            ...
            <div className="flex-1 overflow-y-auto custom-scrollbar pr-1">
              <div className="space-y-[4px]">
                ...
                {awayPlayers.slice(0, 11).map(p => renderPlayerRow(p, 'RIGHT'))}
                {awayPlayers.length > 11 && (
                  <div className="mt-4 pt-4 border-t border-white/5">
                    ...
                    {awayPlayers.slice(11).map(p => renderPlayerRow(p, 'RIGHT', true))}
                  </div>
                )}
              </div>
            </div>
